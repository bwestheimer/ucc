                                            ...
                                            ucc_rank_t      *rank_out)
{
    ...
    status = ucc_topo_get_node_leaders(core_team->artifacts->topo, &node_leaders);
    if (UCC_OK != status) {
...
{
    ucc_topo_t  *topo             =
        cl_team->super.super.params.team->artifacts->topo;
                         ...
                         ucc_coll_task_t **task)
{
    ...
    ucc_topo_t             *topo             = team->params.team->artifacts->topo;
